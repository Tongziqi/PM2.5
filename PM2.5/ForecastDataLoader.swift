...
class ForecastDataLoader {
    ...
    func loadLatest(json: JSON) {
        let datas = [
            ForecastEntry(imageString: json["result"][0]["weather"].stringValue,
            ...
            ForecastEntry(imageString: json["result"][1]["weather"].stringValue,
            ...
            ForecastEntry(imageString: json["result"][2]["weather"].stringValue,
            ...
            ForecastEntry(imageString: json["result"][3]["weather"].stringValue,
            ...
            ForecastEntry(imageString: json["result"][4]["weather"].stringValue,
            ...
            ForecastEntry(imageString: json["result"][5]["weather"].stringValue,
            ...
            ForecastEntry(imageString: json["result"][6]["weather"].stringValue,
